 ...
 *
 */
public class DurabilityEvent extends EventObject
{
	private static final long serialVersionUID = -2703279764623112956L;
	
	private Durability.Phase phase;
	
	protected DurabilityEvent(TransactionIdentifier transactionId, Durability.Phase phase)
	{
