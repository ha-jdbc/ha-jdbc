 ...
 * @since   1.0
 */
public class AbstractPreparedStatement<D, S extends java.sql.PreparedStatement> extends AbstractStatement<D, S> implements java.sql.PreparedStatement
{
	private String sql;
	 ...
	 */
	public AbstractPreparedStatement(Connection<D> connection, Operation<D, java.sql.Connection, S> operation, String sql) throws java.sql.SQLException
	{
	...
	public java.sql.ResultSet executeQuery() throws SQLException
	{
		...
		return (lockList.isEmpty() && (this.getResultSetConcurrency() == java.sql.ResultSet.CONCUR_READ_ONLY) && !this.isSelectForUpdate(this.sql)) ? this.executeReadFromDatabase(operation) : new ResultSet<D, S>(this, operation, lockList);
	}
	...
	{
		Operation<D, S, ResultSetMetaData> operation = new Operation<D, S, ResultSetMetaData>()
		{
			public ResultSetMetaData execute(Database<D> database, S statement) throws SQLException
			{
	...
	{
		Operation<D, S, ParameterMetaData> operation = new Operation<D, S, ParameterMetaData>()
		{
			public ParameterMetaData execute(Database<D> database, S statement) throws SQLException
			{
