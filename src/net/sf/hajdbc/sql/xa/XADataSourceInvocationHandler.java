...
import net.sf.hajdbc.sql.AbstractRootInvocationHandler;
...
public class XADataSourceInvocationHandler extends AbstractRootInvocationHandler<XADataSource>
{
	 ...
	 */
	public XADataSourceInvocationHandler(DatabaseCluster<XADataSource> databaseCluster)
	{
		super(databaseCluster, XADataSource.class);
	}

	@Override
	protected InvocationStrategy<XADataSource, XADataSource, ?> getInvocationStrategy(XADataSource dataSource, Method method, Object[] parameters) throws Exception
	{
