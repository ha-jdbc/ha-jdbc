...
public class ConnectionPoolDataSourceFactory extends CommonDataSourceFactory<ConnectionPoolDataSource>
{
	...
	{
		return DatabaseClusterFactory.getDatabaseCluster(id, ConnectionPoolDataSourceDatabaseCluster.class, ConnectionPoolDataSourceDatabaseClusterMBean.class, config);
	}
