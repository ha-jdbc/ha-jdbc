 ...
 * @since   1.0
 */
public class HostGroupingMailSenderStrategy extends GroupingMailSenderStrategy
{
	/**
	 * @see net.sf.ha.mail.GroupingMailSenderStrategy#groupAddresses(javax.mail.Address[])
	 */
	public Collection groupAddresses(Address[] addresses)
	{
