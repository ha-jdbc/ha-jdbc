...
public class TestStatement extends AbstractTestStatement<Statement>
{
	 ...
	 */
	@Override
	protected Class<Statement> getStatementClass()
	{
		return Statement.class;
	}

	/**
	 * @see net.sf.hajdbc.sql.AbstractTestStatement#getInvocationHandler(java.util.Map)
	 */
	@Override
	protected AbstractStatementInvocationHandler<?, Statement> getInvocationHandler(Map<Database, Statement> map) throws Exception
	{
